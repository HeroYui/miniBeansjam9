...
public class FuchsiUndMiaFindenDasBuecherregalInEinerPrekaerenSituation1 : IDialogMessage
{
    ...
    {
        Message = "Hallo Mia & Fuchsi. Schön euch zu sehen. Seit ihr wieder da, um die Abenteuer der Froschprinzessin Quarkini zu lesen?";
        ActorId = 1;
    }
...
public class FuchsiUndMiaFindenDasBuecherregalInEinerPrekaerenSituation2 : IDialogMessage
{
    ...
    {
        Message = "Liebes Bücherregal, schau mal, wir müssen dringend ins Schlafzimmer unserer Eltern. Kannst du nicht einen kleinen Schritt zur Seite rücken, damit wir vorbeikommen?";
        ActorId = 0;
    }
...
public class FuchsiUndMiaFindenDasBuecherregalInEinerPrekaerenSituation4 : IDialogMessage
{
    ...
    {
        Message = "Wir haben nicht die Zeit dich komplett leerzuräumen. Lasst uns einfach ein paar ausräumen, dann können wir durch dich durchklettern.";
        ActorId = 0;
    }
