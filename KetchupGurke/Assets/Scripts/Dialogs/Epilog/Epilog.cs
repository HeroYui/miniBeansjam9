...
public class Epilog1 : IDialogMessage
{
    ...
    public Epilog1()
    {
        Message = "Die Polizei hat den Einbrecher dank deiner Hilfe schnappen k�nnen, meine kleine Prinzessin. Wir feiern deine Tapferkeit mit einem Eis und einem Tag im Zoo.";
        ActorId = 1;
    }
